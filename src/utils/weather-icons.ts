...
import iconRainDay from '@/assets/icons-weather/rain-moment-day.svg'
import bgRainDay from '@/assets/bg-weathers/rain-day.png'
import bgRainNight from '@/assets/bg-weathers/rain-night.png'

import iconClearDay from '@/assets/icons-weather/clear-day.svg'
import iconClearNight from '@/assets/icons-weather/clear-night.svg'
import bgClearDay from '@/assets/bg-weathers/clear-day.png'
import bgClearNight from '@/assets/bg-weathers/clear-night.png'

import iconSnowDay from '@/assets/icons-weather/snow-day.svg'
import iconSnowNight from '@/assets/icons-weather/snow-night.svg'
